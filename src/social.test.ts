...
import { addFriend, createGroup, EMPTY_SOCIAL_BOOK, groupRecipients, parseInviteCode } from "./social";
...
describe("친구와 그룹", () => {
  ...
  it("주소를 체크섬 형식으로 저장하고 중복을 막는다", () => {
    ...
    expect(() => addFriend(first, "중복", first.friends[0].address)).toThrow("이미 등록");
  });
