...
`cex.aah.name` 서버가 담당합니다. AAH Wallet에는 CEX 출금키를 넣지 않습니다.
...
- 네트워크 비용 계정: 실제 외부 체인 및 AAH 출금 비용

거래마다 총 입금액, 교환 원금, 재단 수수료, 네트워크 비용, 지급 AAH와 온체인
